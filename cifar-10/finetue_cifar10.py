...
optimizer_ft = optim.SGD(params_to_update, lr=0.001, momentum=0.99, weight_decay = 1e-3)
# Setup the loss fxn
criterion = nn.CrossEntropyLoss()
# Train and evaluate
model_ft, hist = train_model(model_ft, dataloaders_dict, criterion, optimizer_ft, num_epochs=num_epochs, is_inception=False)

torch.save(model_ft.state_dict(), "./models/cifar10_finetune_"+str(batch_size)+"_"+str(num_epochs)+".pth")
